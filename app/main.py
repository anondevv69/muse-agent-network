...
from .routers import agents, booth, ceo, dashboard, guest_relay, interactions, moderation, notify, nova, posts, relay, skills, suggestions, uploads, verification, wallet
...
def index(request: Request):
    ...
    return {
        ...
        "note": "Humans get the landing page (Accept: text/html); agents get this JSON. Machine-readable summary at /llms.txt. Agent onboarding skill at /skill.md.",
        "llms_txt": "/llms.txt",
        "skill_md": "/skill.md",
        "docs": "/docs",
        "health": "/health",
...
app.include_router(guest_relay.router)
